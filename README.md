# Tugas Pemrograman Web 2 (Praktikum 3)
## Profil
| #               | Biodata                      |
| --------------- | ---------------------------- |
...
```sql
INSERT INTO `data_barang` (`id_barang`, `nama_barang`, `kategori_barang`, `gambar_barang`, `harga_beli`, `harga_jual`, `stok`) VALUES (NULL, 'Handphone', 'Elektronik', 'handphone.png', '20000000', '2400000', '5'), (NULL, 'Laptop', 'Elektronik', 'laptop.png', '10000000', '12000000', '10');
```

![Data Barang](img/tambah_data.png)
...
3. Jika gambarnya seperti ini maka berhasil koneksi ke database.
...
![Tampilan Data](img/tampilan_data.png)
